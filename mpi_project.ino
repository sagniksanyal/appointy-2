...
#include "MAX30105.h" // Core functions of the sensor
...
// char blynkAuth[] = "YOUR-BLYNK-PROJECT-AUTH-TOKEN"; // Sagnik Sanyal's project auth token
char blynkAuth[] = "UqgTj96eDTbE2keH8TA7kSfVq8Oc8QTv"; // Prakrit Raj's project auth token
BlynkTimer sendTimer;
WidgetLCD lcd(V5); // Configure Virtual Pin V5 of Blynk for LCD
// Variables for ESP8266
// Set password to "" for open networks.
char ssid[] = "ROBOT";
char pass[] = "CameraMan6";
