<?php
 ...
 <div class="manage-bar">
   ...
   <input type="text" name="search" id='search' value="" placeholder="Search Notice.." class="search">
   ...
   <h2 class="notice-top">
     ...
     <?php
       while($row=mysqli_fetch_assoc($result)){
           ...
           echo $row['content'];
           echo "<div class='edit'>";
           echo "<a href='".url_for("/admin/notice/delete_notice.php?id=".$row['nid'])."' style='background-color:red'><img src='";
           echo url_for("/images/delete.svg");
           echo "'></a>";
           echo "<a href='".url_for("/admin/notice/edit_notice.php?id=".$row['nid'])."' style='background-color:green'><img src='";
           echo url_for("/images/edit.svg");
           echo "'></a>";
           echo "<a href='".url_for("/admin/notice/show_notice.php?id=".$row['nid'])."' style='background-color:black'><img src='";
